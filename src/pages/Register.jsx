...
const Register = () => {
  ...
  const handleSubmit = async(e) =>{
    ...
    try {
      ...
      }).then((res)=>res.data && navigate('/home') );
    } catch (error) {
      console.log(error);
    }
