    ...
    <Fragment>
            ...
            <form action="" onSubmit={handleSubmit}>
                ...
                <div className="flex">
                  ...
                  <input type="password" autoComplete='off' name="username" id="username" className="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 max-w-lg" placeholder="elonmusk" value={password} onChange={(e)=>{setPassword(e.target.value)}} />
                </div>
